...
function my_keydown(e){
    ...
    function up(){
        if(player_y>=0){
            ...
            console.log("when up arrowkey is pressed x=" + player_x + "and y=" + player_y);
    ...
    function left(){
        if(player_x>=0){
            ...
            console.log("when left arrowkey is pressed x=" + player_x + "and y=" + player_y);
            canvas.remove(player_objects);
            player_update();
        }
    }
    ...
    function right(){
        if(player_x<=900){
            player_x = player_x + block_image_width;
            console.log("block_image_width is  " + block_image_width);
            console.log("when right arrowkey is pressed x=" + player_x + "and y=" + player_y);
            canvas.remove(player_objects);
            player_update();
        }
    }
